...
@ddt
class test_8工单售后运维回显(unittest.TestCase):
    yamlPath = ['4工单售后运维', '7工单售后运维回显.yaml']
    ...
    flowId = db.getprojectId("flow_id", "work_order_info")
    case_list = eval(findAndReplace(str(case_list), {"flowId": flowId}))
