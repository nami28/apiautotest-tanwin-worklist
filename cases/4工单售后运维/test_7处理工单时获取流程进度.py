...
@ddt
class test_7处理工单时获取流程进度(unittest.TestCase):
    yamlPath = ['4工单售后运维', '处理工单时获取流程进度.yaml']
    ...
    processInstanceId = db.getprojectId("flow_id", "work_order_info")
    case_list = eval(findAndReplace(str(case_list), {"processInstanceId": processInstanceId}))
