...
@ddt
class test_重新指派(unittest.TestCase):
    yamlPath = ['3电站列表', '重新指派.yaml']
    ...
    case_list = eval(findAndReplace(str(case_list), {"stationIds": confParam("stationId")}))
